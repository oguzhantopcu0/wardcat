...
# GLiNER (zero-shot transformer NER) label → wardcat entity type.
# The keys are the labels the GLiNER2 model is asked to extract; the values are
# the wardcat entity types they map onto. GLiNER is a probabilistic layer, so
...
# wardcat counterpart (drivers_license, card_cvv, username, …) are left out on
