...
CATALOG: list[ModelInfo] = [
    ...
    ModelInfo(
        ...
        vram_gb=2.5,
        description="Llama 3.2 1B Instruct · Test / CPU · pip install wardcat[transformers]",
        backend="transformers",
    ),
    ModelInfo(
        name="meta-llama/Llama-3.2-3B-Instruct",
        vram_gb=6.0,
        description="Llama 3.2 3B Instruct · ~6 GB VRAM · pip install wardcat[transformers]",
        backend="transformers",
    ),
    ModelInfo(
        name="meta-llama/Llama-3.1-8B-Instruct",
        vram_gb=16.0,
        description="Llama 3.1 8B Instruct · 16 GB VRAM (8-bit: ~8 GB) · pip install wardcat[transformers]",
        backend="transformers",
    ),
    ModelInfo(
        name="meta-llama/Llama-3.1-70B-Instruct",
        vram_gb=40.0,
        description="Llama 3.1 70B Instruct · Multi-GPU / requires 4-bit · pip install wardcat[transformers]",
        backend="transformers",
    ),
]
