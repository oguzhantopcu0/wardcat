...
ai-guard entity types via :data:`~ai_guard.core.registry.GLINER_LABEL_MAP`.
...
Install it with ``pip install "ai-guard[gliner]"``.
"""
...
from ai_guard.core.registry import GLINER_LABEL_MAP
...
# AIGuard instances. Thread-safe via _CACHE_LOCK.
